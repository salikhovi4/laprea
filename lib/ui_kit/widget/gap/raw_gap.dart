...
class RawGap extends LeafRenderObjectWidget {
  const RawGap(
      this.mainAxisExtent, {
        super.key,
...
class RenderGap extends RenderBox {
  ...
  Size computeDryLayout(BoxConstraints constraints) {
    ...
    if (direction != null) {
      ...
      throw FlutterError(
        'Виджет Gap должен быть размещен непосредственно внутри виджета Flex, '
            'иначе его fallbackDirection не должен иметь значение null.',
      );
    }
  }
