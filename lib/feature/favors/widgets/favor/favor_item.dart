      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(item.serviceName, style: context.textSmRegular()),
                      ),
                      const Gap(8),
                      Text(item.durationStr(), style: context.textXsRegular()),
                    ],
                  ),
                  // Text(
            ...
            const Gap(8),
            Text(item.priceStr(), style: context.textBaseMedium()),
          ],
        ),
      ),
    );
